...
import { EpicFailure, Normalized, SoundCloud, ThunkResult } from '@types';
...
)<{ playlistId: PlaylistIdentifier }, { playlistId: PlaylistIdentifier; items: ObjectStateItem[] }, EpicFailure>();
...
)<Normalized.NormalizedResult, { items: ObjectStateItem[] }, EpicFailure>();

export const upNextInsert = createAction(PlayerActionTypes.ADD_UP_NEXT)<ObjectStateItem[]>();
