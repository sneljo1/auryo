...
export const setObject = (objectId: string, objectType: ObjectTypes, entities: NormalizedEntities, result: Array<NormalizedResult>, nextUrl = null, futureUrl = null) =>
    action(ObjectsActionTypes.SET, {
        objectId,
        objectType,
        entities,
        result,
