...
import { toggleStatus, updateTime } from '../../../renderer/modules/player/player.actions';
        ...
        if (((next_index === queue.length && !currentPlaylistObject.nextUrl) || next_index === -1)) {
            ...
            if (next_index <= (queue.length - 1)) {
                ...
                if (next_track) {
                    ...
                    let track_ent = track_entities[trackId];
                    ...
                    if (!track_ent) {
                        ...
                        if (next_track.playlistId !== currentPlaylistId) {
                            const playlist = playlist_entities[next_track.playlistId];
                            dispatch(playTrack(currentPlaylistId, next_track, playlist));
                        } else {
