						...
						{track.kind !== "playlist" ? (
							<MenuItem text="Add to playlist">
								<div style={{ fontSize: ".8rem", opacity: 0.8, color: "grey", padding: "5px" }}>
									I'm sorry, this feature has been disabled to preserve your playlists. Since we are
									unable to fetch all tracks, we do not know for sure if we will delete tracks upon
									adding/removing track via Auryo.
								</div>
