...
export const WelcomeStep = React.memo<Props>(({ onNext }) => (
	<>
		...
		<div className="sub-title animated fadeInLeft faster second">
			...
			<strong className="text-primary">15.000 streams/day</strong>. After this, there will be a waiting period
			where no music can be listened to. You may also notice that some music may not be available in the desktop
			version because every song owner has the option to disable access for third party applications such as this
			one.
		</div>
