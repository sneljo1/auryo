	...
	<>
		...
		<div className="sub-title animated fadeInLeft faster second">
			...
			<div className="description mb-3">
				I use <a href="https://analytics.google.com">google analytics</a> to get an insight how large the
				userbase of the app is. Your ip is being anonymized and no other data than page views and sessions are
				being tracked.
			</div>
			...
			<div className="description">
				I use <a href="https://sentry.io">Sentry</a> for error logging. No personal info from your pc is being
				sent. If we don't have your crash reports, it's harder for us to fix bugs.
			</div>
		</div>
