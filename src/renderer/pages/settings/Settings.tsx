					...
					},
					{
						...
						setting: (
							<InputConfig
								...
								description={
									<div>
										Read <a href="https://github.com/Superjo149/auryo/wiki/Custom-clientId">here</a>{" "}
										why and how.
									</div>
								}
							/>
					...
					{authenticated && (
						<div className="donationBox">
							...
							<div>
								...
								<div>
									I would love to spend more time on this, and other open-source projects. I do not
									earn anything off this project, so I would highly appreciate any financial
