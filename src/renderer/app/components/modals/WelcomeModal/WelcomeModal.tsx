...
const WelcomeModal = React.memo<IModalInjectedProps>(({ show, handleHide }) => (
    <Modal isOpen={show} toggle={handleHide} className='welcome'>
        <ModalBody>
            <h2>Welcome to Auryo</h2>
            <img className='logo' src={imgUrl} />
            <div className='welcome__description'>
                Due to the limitations of SoundClouds APIs, we are limited to 15K streams/day. After this,
                there will be a waiting period where no music can be listened. Also some music may not be
...
export default connectModal({ name: 'welcome' })(WelcomeModal);
