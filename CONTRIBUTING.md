...
## Report bugs using Github's [issues](https://github.com/Superjo149/auryo/issues)
...
* You can run `yarn run lint` for style unification

## License
By contributing, you agree that your contributions will be licensed under its GPL-3 License.

## References
This document was adapted from the open-source contribution guidelines for [Transcriptase](https://github.com/briandk/transcriptase)
